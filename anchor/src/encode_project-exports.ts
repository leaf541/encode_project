...
export const ENCODE_PROJECT_PROGRAM_ID = new PublicKey(EncodeProjectIDL.address)

// This is a helper function to get the EncodeProject Anchor program.
export function getEncodeProjectProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...EncodeProjectIDL, address: address ? address.toBase58() : EncodeProjectIDL.address } as EncodeProject, provider)
}
